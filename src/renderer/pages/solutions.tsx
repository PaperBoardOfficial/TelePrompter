...
import ScreenshotQueue from "@/renderer/components/queue/screenshot-queue";

import { ProblemStatementData } from "@/renderer/types/solutions";
import SolutionCommands from "@/renderer/components/solutions/solution-command";
  ...
  const handleDeleteExtraScreenshot = async (index: number) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast.error("Error", "Failed to delete the screenshot");
      }
    } catch (error) {
